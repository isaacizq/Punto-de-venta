 ...
 * @author isaac
 */
public class Form_Proveedor extends javax.swing.JDialog {

    private ProveedoresJpaController cp;
    private Proveedores probus;

    /**
     * Creates new form Form_Proveedor
     */
    public Form_Proveedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setTitle("Registro de Proveedores");
        this.setLocationRelativeTo(null);
        cp = new ProveedoresJpaController();
        probus = null;
        cargartabla();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Nombre", "Dirección", "Telefono 1", "Telefono 2"
            }
        ));
    ...
    private void CreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CreateActionPerformed
        ...
        if (ValidarCampo()) {
            ...
            try {
                ...
                int unida = Integer.parseInt(txt_tel1.getText());
                int precio = Integer.parseInt(txt_tel2.getText());
                Proveedores pr = new Proveedores();
                pr.setCodigo(codigo);
                pr.setNombre(nombre);
                pr.setDireccion(descrip);
                pr.setTelefono1(unida);
                pr.setTelefono2(precio);
                cp.create(pr);
                agregarregistro(codigo, nombre, descrip, unida, precio);
    ...
    private void UpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateActionPerformed
        ...
        probus.setDireccion(descrip);
        probus.setTelefono1(unida);
        probus.setTelefono2(precio);
    ...
    private void DeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteActionPerformed
        ...
        if (rta == 0) {
            try {
                ...
                Logger.getLogger(Form_Proveedor.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void cargartabla() {
        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
        List<Proveedores> si = cp.findProveedoresEntities();
        for (int i = 0; i < si.size(); i++) {
            Object fila[] = {si.get(i).getCodigo(), si.get(i).getNombre(),si.get(i).getDireccion(),si.get(i).getTelefono1(),si.get(i).getTelefono2()};
            model.addRow(fila);
        }

    }

    public void agregarregistro(int codigo, String nombre, String direccion, int tel1, int tel2) {
        Object fila[] = {codigo, nombre, direccion, tel1, tel2};
        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
        model.addRow(fila);
    }

    public void mconsulta(Proveedores med) {
        Object fila[] = {
            med.getCodigo(),
            med.getNombre(),
            med.getDireccion(),
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Form_Proveedor dialog = new Form_Proveedor(new javax.swing.JFrame(), true);
